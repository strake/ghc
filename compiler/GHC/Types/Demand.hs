...
splitStrProdDmd n (SProd ds) = warnPprTrace (not (ds `lengthIs` n))
                                     (text "splitStrProdDmd" $$ ppr n $$ ppr ds $$ callStackDoc) $
                               Just ds
...
splitUseProdDmd n (UProd ds)  = warnPprTrace (not (ds `lengthIs` n))
                                (text "splitUseProdDmd" $$ ppr n $$ ppr ds $$ callStackDoc) $
                                Just ds
