...
linkingNeeded dflags staticLink linkables pkg_deps = do
  ...
  case e_exe_time of
    ...
    Right t -> do
        ...
        pkg_libfiles <- mapM (uncurry (findHSLib platform (ways dflags))) (fmap ST.unpack <$> pkg_hslibs)
...
findHSLib :: Foldable f => Platform -> f Way -> [String] -> String -> IO (Maybe FilePath)
findHSLib platform ws dirs lib = do
  let batch_lib_file
        | WayDyn `notElem` ws = "lib" ++ lib <.> "a"
        | otherwise = platformSOName platform lib
        ...
        case result of
            ...
            HscRecomp { hscs_guts = cgguts,
              ...
              -> do output_fn <- phaseOutputFilename next_phase
                    ...
                    setting_ ifaceL $ Just final_iface
