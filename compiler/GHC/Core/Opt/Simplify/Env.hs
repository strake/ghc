...
simplNonRecJoinBndr :: SimplEnv -> InBndr -> OutType
...
simplNonRecJoinBndr env id res_ty
  = do { let (env1, id1) = simplJoinBndr res_ty env id
       ; seqId id1 `seq` return (env1, id1) }
...
---------------
adjustJoinPointType :: Type     -- New result type
                    -> Id       -- Old join-point Id
                    -> Id       -- Adjusted jont-point Id
-- (adjustJoinPointType new_res_ty join_id) does one thing:
--
