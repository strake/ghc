...
ppHtml pkgState doctitle maybe_package ifaces reexported_ifaces odir prologue
  ...
  when (isNothing maybe_contents_url) $
    ppHtmlContents pkgState odir doctitle maybe_package
